...
class ChartingState extends MusicBeatState
{
	...
	var noteShittyText:FlxText = new FlxText(0, 0, 0, 'Note Type: ', 32);
	...
	**/
	...
	override function update(elapsed:Float)
	{
		updateHeads();
		add(noteShittyText);
		noteShittyText.scrollFactor.set();
		...
		if (!typingShit.hasFocus)
		{
			...
			if (FlxG.keys.justPressed.I){
				...
				if (noteType < 0){
					...
					noteShittyText.text = 'Note Type: $Type';
				}
			}
				...
				noteShittyText.text = 'Note Type: $noteType';
			}
